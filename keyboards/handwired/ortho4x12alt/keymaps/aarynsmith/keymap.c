...
// Layer Numbers
enum layers { _TEST = 0, _QWERTY, _LOWER, _RAISE, _ADJUST, _SPACEFN, _QMK };
...
[_TEST] = LAYOUT_ortho_4x12(
    KC_A,    QMKBEST, TBFLIP,  RGB_MOD, RGB_VAI, RGB_VAD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
